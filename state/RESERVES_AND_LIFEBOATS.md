...
**essential function:** Essential transport, harvest and backup power
...
**donor guardrail:** Confirm exportable supply after local use, contracted sales and contingency needs

**essential function:** Staple food supply

**id:** RES02

**limits:** Not all stocks exportable; payment/ports/nutrition constrain access
...
**donor guardrail:** Do not lend assumed spare transit service or capital funding to other agencies

**essential function:** Maintain current essential regional mobility

**id:** RES03

**limits:** Time-limited, partly debt/deferral; not unrestricted cash
...
**donor guardrail:** Check simultaneous peak/hazard and retain donor contingency margin before imports counted

**essential function:** Electricity supply

**id:** RES04

**limits:** Live reserves, ramp, duration and interfaces unresolved
...
**donor guardrail:** Verify home-country service floor and ready teams; roster count not spare headcount

**essential function:** Recovery coordination and temporary care

**id:** RES05

**limits:** Travel, funds, simultaneous disasters and home staffing constrain
...
**type:** Rescue / Lifeboat


---

**donor guardrail:** Preserve existing client allocations; no promise of extra distribution before partner agreement

**essential function:** Locate groceries or meals

**id:** RES06

**limits:** Inventory, transport, opening and dietary suitability not guaranteed
...
**donor guardrail:** Respect lending limits and member access; only available compatible tools count

**essential function:** Household/community maintenance

**id:** RES07

**limits:** Eligibility and inventory; not a skilled utility repair crew
...
**donor guardrail:** Never divert host organization baseline services or assume around-the-clock opening

**essential function:** Potential cooling, communications and essential charging

**id:** RES08

**limits:** Hours, power, water, staffing, islanding and accessibility need confirmation
...
**donor guardrail:** Each partner declares protected routes/driver hours and caps contributions; stop before fatigue or service loss

**essential function:** Appointments, groceries and essential supplies

**id:** RES09

**limits:** Drivers, insurance, accessibility, vehicle capacity and reimbursements required
...
**type:** Release / Substitution / Lifeboat


---

**donor guardrail:** Protect host critical load first; minimum duration and replenishment required

**essential function:** Communications and suitable food refrigeration

**id:** RES10

**limits:** Watts, usable kWh, starting load, temperature monitoring, islanding and recharge must be verified
...
**donor guardrail:** Preserve existing deliveries and rest; verify real uncommitted compatible equipment before diversion

**essential function:** Timely food transport
...
**donor guardrail:** Town Hall and local essential service floor first; no regional surge promise or presumed East Bay access

**essential function:** Potential communications and temperature refuge during outages
...
**donor guardrail:** No export credit until current domestic/environmental commitments, treatment and route capacity known

**essential function:** Source-water context
...
**donor guardrail:** Do not assume funds can be redirected; preserve existing patient services and staffing

**essential function:** Potential support for continuing local healthcare
