...
**donor guardrail:** Deduct domestic requirements, sold cargoes, maintenance and logistics reserve before offering additional tonnes

**id:** ISL01

**limits:** One nutrient and one producer record do not prove whole-region independence. Nutrients serve different functions; CF available-capacity utilization excludes an idled complex and is not spare capacity.

**name:** Canadian potash / North American agricultural network

## needs in return

- Fuel, rail/ports, equipment, other nutrients and functioning payment/trade channels

## offers

- Potash production; complementary North American crop supply

**self sufficient:** False

**Sources:** [SRC07: Nutrien](https://www.nutrien.com/news/press-releases/nutrien-reports-second-quarter-2026-results-1753), [SRC06: FAO](https://www.fao.org/worldfoodsituation/csdb/en/), [TRS01: CF Industries](https://ir.cfindustries.com/Investors/news/news-details/2026/CF-Industries-Holdings-Inc--Reports-First-Half-2026-Net-Earnings-of-1-34-Billion-Adjusted-EBITDA-of-2-18-Billion/default.aspx)
...
**donor guardrail:** Verify exportable stocks and route capacity; avoid draining local food affordability

**id:** ISL02

**limits:** Forecast outputs and trade prospects, not contracted emergency shipments. Operating grain rail/barge flows do not imply uncommitted refrigerated transport.

**name:** Diversified cereal origins in the Americas

## needs in return

- Shipping, insurance, finance, equipment and fertilizer

## offers

- Alternative grain sourcing under FAO outlook

**self sufficient:** False

**Sources:** [SRC06: FAO](https://www.fao.org/worldfoodsituation/csdb/en/), [FF-S05: USDA AMS](https://www.ams.usda.gov/sites/default/files/media/GTR09172026.pdf)
...
**donor guardrail:** Use hourly deliverable reserve after each donor reliability margin and coincident weather risk

**id:** ISL03

**limits:** Network has localized vulnerabilities; NATO membership does not confer spare electricity.

**name:** Interconnected European power systems

## needs in return

- Fuels, equipment, transfer capacity and reciprocal assistance

## offers

- Coordinated power exchange when available
...
**donor guardrail:** No team deployed below home essential staffing; diversify donors outside common storm footprint

**id:** ISL04

**limits:** Historical medical deployment and new roster do not establish current surge strength.

**name:** Caribbean mutual-aid institutions

## needs in return

- Transport, funded deployment, medicines/equipment, replenishment and donor staff coverage

## offers

- Recovery expertise and demonstrated temporary clinical support
...
**donor guardrail:** Declare protected service levels and explicit contribution ceilings at each node

**id:** ISL05

**limits:** Relative institutional strengths only; no food, energy or fiscal self-sufficiency established.

**name:** East Bay civic and commons network

## needs in return

- Operating funds, staffing, accessible transport, electricity and reciprocal labor

## offers

- Food navigation, tools, trusted spaces and potential hub collaboration

**self sufficient:** False

**Sources:** [SRC20: Oakland Public Library](https://oaklandlibrary.org/otll/), [SRC21: Alameda County Community Food Bank](https://www.accfb.org/get-food/), [SRC22: NorCal Resilience Network](https://norcalresilience.org/resilient-hub-initiative/)


---

**available surplus:** Unknown; no receiving capacity or transferable electricity promised

**donor guardrail:** Protect local critical functions and test common-hazard/access limitations before offering help
...
**needs in return:** Staffing, maintenance, accessible operations, food/water and replenishment support
